"""
Django settings for kmtest_12 project.
...
WSGI_APPLICATION = 'kmtest_12.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kmtest_12 API",
    "DESCRIPTION": "API documentation for kmtest_12 App",
    "VERSION": "v1",
}
